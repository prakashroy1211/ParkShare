...
DATABASES = {
    'default': {
        ...
        'NAME': 'parksharedb',  # Name of your database
        'USER': 'parkshare',  # Using the default postgres user
        'PASSWORD': 'Prakash24100534',  # The password for the 'postgres' user
        'HOST': 'parksharedb.c7k4662ko9zg.ap-south-1.rds.amazonaws.com',  # or the IP address of your PostgreSQL server
